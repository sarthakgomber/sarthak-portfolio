      ...
      <div className="section-wrap">
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.2fr', gap: '5rem', alignItems: 'center' }}>
          ...
          <div>
            ...
            <h2 className="chrome-heading" style={{ fontSize: 'clamp(2.2rem, 4vw, 3.8rem)', marginBottom: '2rem', lineHeight: 1.15 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem' }}>
              {stats.map(s => (
                <div key={s.label} className="glass" style={{ padding: '1.2rem 1.4rem' }}>
                  ...
                  <div className="chrome-label" style={{ fontSize: '0.6rem' }}>{s.label}</div>
                </div>
              ))}
            </div>
          </div>
